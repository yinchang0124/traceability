...
public class buyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_buyInfo=(TextView)findViewById(R.id.tv_buyinfo);
        tv_buyInfo.setOnClickListener(this);
        ...
        AndPermission.with(this)
                ...
                .onGranted(new Action() {
                    ...
                    public void onAction(List<String> permissions) {
                        Intent intent = new Intent(buyActivity.this, CaptureActivity.class);
...
//                                config.setScanLineColor(R.color.colorAccent);//设置扫描线的颜色 默认白色
                ...
                .onDenied(new Action() {
                    ...
                    public void onAction(List<String> permissions) {
                        ...
                        Toast.makeText(buyActivity.this, "没有权限无法扫描呦", Toast.LENGTH_LONG).show();
                    }
                }).start();
    }
}

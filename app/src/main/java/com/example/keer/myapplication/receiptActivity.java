...
public class receiptActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_receipt=(Button)findViewById(R.id.btn_buy_receipt);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.btn_buy_receipt){
            final AlertDialog.Builder builder = new AlertDialog.Builder(receiptActivity.this);
            ...
            AndPermission.with(this)
                    ...
                    .onGranted(new Action() {
                        ...
                        public void onAction(List<String> permissions) {
                            Intent intent = new Intent(receiptActivity.this, CaptureActivity.class);
...
//                                config.setScanLineColor(R.color.colorAccent);//设置扫描线的颜色 默认白色
                    ...
                    .onDenied(new Action() {
                        ...
                        public void onAction(List<String> permissions) {
                            ...
                            Toast.makeText(receiptActivity.this, "没有权限无法扫描呦", Toast.LENGTH_LONG).show();
                        }
                    }).start();
        }
    }
